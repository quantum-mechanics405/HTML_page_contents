...
r = table.find_all('tr')
rows = r[1:]
dictionary = {'Name':[],'Born':[],'Reigned from':[],'Reigned until':[],'Relationship with Muhammad PBUH':[]}
for row in rows:
    ...
    dictionary['Relationship with Muhammad PBUH'].append(cells[5].get_text().strip())


df = pd.DataFrame.from_dict(dictionary)
# df.to_csv('muslim_rulers/Rashidun_Caliphate.csv',index=False)
print(df.head(5))
